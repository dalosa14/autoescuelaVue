...
export default new Vuex.Store({
    ...
    mutations: {
        ...
        //se pasa a la siguiente pregunta del test ,si se llega a la ultima se envia al usuario a la vista final
        ...
        backPreguntaActual(state) {

            if (state.test.actualPregunta - 1 == -1) return
            state.test.actualPregunta -= 1
        },
